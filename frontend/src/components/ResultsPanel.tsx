...
export default function ResultsPanel({
  ...
  return (
    <div data-tour={attr('results-panel')} className="p-5 flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <div data-tour={attr('results-toggle')} className="flex rounded-lg border border-gray-200 text-sm font-semibold">
          <button
        ...
        <div className="flex justify-between text-xs text-zinc-500 px-1">
          ...
          <span>
            {(activeSolution.total_distance_meters / 1609).toFixed(0)} mi total
            {showOptimized && (() => {
      ...
      <div data-tour={attr('results-truck-list')} className="flex flex-col gap-3">
