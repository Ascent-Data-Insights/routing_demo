...
export const desktopSteps: TourStep[] = [
  ...
  },
  {
    ...
    content: "Click Run Optimization — routes are computed in seconds, even with dozens of containers and destinations.",
    placement: 'top',
    disableBeacon: true,
  },
  {
    target: '[data-tour="map-area"]',
    content: "The map displays your optimized routes in real time. This demo uses a baseline algorithm — it can be customized further with additional constraints like time windows, driver schedules, or vehicle types.",
    placement: 'center',
    disableBeacon: true,
...
export const mobileSteps: TourStep[] = [
  ...
  },
  {
    ...
    content: 'Set how much each truck can carry — separate slots for ambient and refrigerated.',
    placement: 'bottom',
    disableBeacon: true,
    data: { requiredTab: 'panel' },
  },
  {
    ...
    content: 'Tap Run Optimization — routes are computed in seconds, even with many containers and destinations.',
    placement: 'top',
    disableBeacon: true,
    data: { requiredTab: 'panel' },
  },
